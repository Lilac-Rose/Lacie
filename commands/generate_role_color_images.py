...
class ColorImageGen(commands.Cog):
    ...
    def _reload_config(self):
        ...
        # role_color.py is the source of truth for the color list — pull from there
    ...
    async def generate_list(self, ctx):
        ...
        try:
            ...
            # pre-measure all role names so we know how wide to make each column
            ...
            for color_role in color_roles:
                # shift x position over by one column's worth for every COLUMN_SIZE roles
